...
if __name__ == "__main__":
    ...
    alipay = AliPay(
        ...
        app_private_key_path="../integral/keys/private_2048.txt",
        alipay_public_key_path="../integral/keys/alipay_key_2048.txt",  # 支付宝的公钥，验证支付宝回传消息使用，不是你自己的公钥,
        debug=True,  # 默认False,
